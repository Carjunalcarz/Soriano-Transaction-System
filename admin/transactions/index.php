				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class=""><p class="m-0 truncate-1" style="font-size:13px"><?php echo date("M-d-y H:i",strtotime($row['date_created'])) ?></p></td>
							<td class=""><p style="font-size:14px" class="m-0 truncate-1"><?php echo $row['code'] ?></p></td>
							<td class=""><p style="font-size:14px" class="m-0 truncate-1"><?php echo $row['client_name'] ?></p></td>
							<td class=""><p style="font-size:14px" class="m-0 truncate-2"><?php echo $row['client_purpose'] ?></p></td>
							<td class=""><p style="font-size:14px" class="m-0 truncate-2"><?php echo $row['client_or'] ?></p></td>
