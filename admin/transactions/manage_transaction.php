                ...
                <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
                    <fieldset class="border-bottom">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="client_purpose" class="control-label">Client Purpose</label>
                                <textarea rows="3" name="client_purpose" id="client_purpose" class="form-control form-control-sm rounded-0" required><?= isset($client_purpose) ? $client_purpose : "N/A" ?></textarea>
                            </div>
                             <div class="form-group col-md-6">
                                <label for="client_or" class="control-label">OR Number</label>
                                <textarea rows="1" name="client_or" id="client_or" class="form-control form-control-sm rounded-0" required><?= isset($client_or) ? $client_or : "N/A" ?></textarea>
                            </div>
                              <div class="form-group col-md-2">
                                <label for="client_station" class="control-label">Meter Station</label>
                                <textarea rows="1" name="client_station" id="client_station" class="form-control form-control-sm rounded-0" required><?= isset($client_station) ? $client_station : "N/A" ?></textarea>
                            </div>
                              <div class="form-group col-md-2">
                                <label for="client_meter" class="control-label">Meter Number</label>
                                <textarea rows="1" name="client_meter" id="client_meter" class="form-control form-control-sm rounded-0" required><?= isset($client_meter) ? $client_meter : "N/A" ?></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="client_address" class="control-label">Address</label>
                                <textarea rows="3" name="client_address" id="client_address" class="form-control form-control-sm rounded-0" required><?= isset($client_address) ? $client_address : "Brgy. Soriano Cabadbaran City" ?></textarea>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
