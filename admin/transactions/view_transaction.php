                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label class="control-label text-muted">Meter Station</label>
                                <div class="pl-4"><?= isset($client_station) ? $client_station: 'N/A' ?></div>
                            </div>
                             <div class="form-group">
                                <label class="control-label text-muted">Meter Number</label>
                                <div class="pl-4"><?= isset($client_meter) ? $client_meter: 'N/A' ?></div>
                            </div>
                        </div>
                         <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label text-muted">Purpose</label>
                                <div class="pl-4"><?= isset($client_purpose) ? $client_purpose: 'N/A' ?></div>
                            </div>
