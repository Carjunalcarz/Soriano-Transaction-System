				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class=""><p class="m-0"><?php echo $row['client_purpose'] ?></p></td>
							<td class=""><p class="m-0"><?php echo $row['client_or'] ?></p></td>
					...
					<?php endwhile; ?>
						<tr>
								<td colspan="6"><p style="text-align: center;">Total</p></td>
