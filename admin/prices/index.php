...
<div class="card card-outline card-black rounded-0 shadow">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-success"><span class="fas fa-plus"></span>  Add New Price</a>
		</div>
		<?php endif; ?>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-hover table-striped">
				...
				<thead>
					<tr class="bg-gradient-black text-light">
						<th>#</th>
						<th>Date Created    </th>
						<th>Category</th>
						<th>Price</th>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="truncate-1"><?php echo date("M-d-y H:i",strtotime($row['date_created'])) ?></td>
							<td class=""><p class="m-0 truncate-2"><?php echo $row['category'] ?></p></td>
